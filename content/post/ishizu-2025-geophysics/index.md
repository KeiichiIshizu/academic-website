---
title: "シャープな境界を決定するインバージョンアルゴリズム (Ishizu et al., 2025, Geophysics)"
date: 2025-01-01
summary: "先験情報に依存しすぎないデータドリブンなシャープ境界再現可能な逆解析アルゴリズム開発"
authors: ["admin"]
tags: ["論文解説", "Geophysics", "Inversion"]
---
...
![図は、Ishizu et al. (2025) Geophysicsより改変。提案手法では 、シャープ境界を正しく再現できている。](figure1.png)
